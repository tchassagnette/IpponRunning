package fr.ippon.running.config.apidoc;
...
public class ApiPathProvider implements SwaggerPathProvider {
	...
	public String getRequestMappingEndpoint(String requestMappingPattern) {
		return defaultSwaggerPathProvider
				.getRequestMappingEndpoint(requestMappingPattern);
	}

	public void setDefaultSwaggerPathProvider(
